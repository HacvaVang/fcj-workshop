...
* Kết nối nhóm FCAJ, nắm rõ nội quy và thống nhất đề tài thực tập.
* Hiểu được khái niệm AWS và  nắm được các nhóm dịch vụ chính (Compute, Storage, Networking, Database)
...
* Thiết kế được kiến trúc VPC đơn giản trên **draw.io**. 
...
* Thực hành triển khai:
  * Thiết kế sơ đồ VPC Multi-AZ trên draw.io.
  * Khởi tạo VPC, Subnet, Route Table, IGW và triển khai EC2 (SSH, gắn EBS volume).
  * Trải nghiệm ứng dụng Serverless đơn giản với Lambda Function URL và chạy thử prompt trên Amazon Bedrock.
