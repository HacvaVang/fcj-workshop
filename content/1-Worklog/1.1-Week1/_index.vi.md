...
| 4 | 10/06/2026 | **Thực tập tại công ty.**<br>**Tìm hiểu về VPC, một số khái niệm cơ bản liên quan.**<br>**Tìm hiểu về bảo mật trong VPC và cách mà các VPC giao tiếp.**<br>**Tìm hiểu về VPN và cơ chế cân bằng tải Estatic.**<br><strong>Thực hành:</strong><br>&emsp;+ Cách khởi tạo VPC, Subnetting, cấu hình bảng Router, cổng Internet Gateway.<br>&emsp;+ Tạo máy chủ ảo EC2 để kiểm thử kết nối. | <https://cloudjourney.awsstudygroup.com/><br><https://www.youtube.com/playlist?list=PLahN4TLWtox2a3vElknwzU_urND8hLn1i> |
| 5 | 11/06/2026 | **Làm quen với cách thiết kế kiến trúc AWS trên draw.io.**<br><strong>Thực hành:</strong><br>&emsp;+ Cách khởi tạo VPC, Subnetting, cấu hình bảng Router, cổng Internet Gateway.<br>&emsp;+ Tạo máy chủ ảo EC2 để kiểm thử kết nối.<br>&emsp;+ Thiết kế được kiến trúc VPC Đa vùng khả dụng đơn giản. | <https://cloudjourney.awsstudygroup.com/><br><https://www.youtube.com/playlist?list=PLahN4TLWtox2a3vElknwzU_urND8hLn1i> |
...
* **Onboarding & Kết nối nhóm:**
  * Kết nối nhóm FCAJ, nắm rõ nội quy.
  * Thiết lập môi trường làm việc chung với Git và AWS Free Tier account.

* **Hiểu biết cơ bản về AWS:**
  * Nắm được khái niệm AWS và các nhóm dịch vụ chính như Compute, Storage, Networking và Database.
  * Thực hành tạo EC2, cấu hình SSH, gắn EBS volume và hiểu quy trình khởi tạo tài nguyên.
  * Trải nghiệm AWS Lambda, Lambda Function URL và Amazon Bedrock để làm quen với serverless và Generative AI.

* **Quản lý tài khoản & công cụ:**
  * Cài đặt AWS CLI, cấu hình Access Key/Secret Key và Region mặc định.
  * Sử dụng AWS CLI để kiểm tra tài khoản, liệt kê Region, xem dịch vụ EC2, tạo key pair và quản lý tài nguyên.
  * Kết hợp quản lý bằng Console và CLI trong cùng một workflow.

* **Thiết kế hệ thống:**
  * Thiết kế sơ đồ VPC đơn giản và VPC Multi-AZ trên draw.io để chuẩn hóa tư duy kiến trúc AWS.
  * Có khả năng mô hình hóa môi trường mạng, route table và gateway trong kiến trúc đám mây.
